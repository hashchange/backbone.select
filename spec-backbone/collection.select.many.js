(function() {
  ...
  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  //
  // Collection tests, taken from Backbone. Partial copy: includes tests relating to instantiation,
  // add, remove, reset, set, create.
  //
  // Tests are modified. Backbone.Model and Backbone.Collection have been augmented with the
  // Select.Me and Select.Many mixin.
  //
  // Source of tests: /tests/collection.js, Backbone 1.3.3.
  //
  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  var a, b, c, d, e, col, otherCol, originalCollectionConstructor, originalModelConstructor;

  QUnit.module('Backbone.Collection', {

    before: function (assert) {
      originalModelConstructor = Backbone.Model;
      originalCollectionConstructor = Backbone.Collection;
